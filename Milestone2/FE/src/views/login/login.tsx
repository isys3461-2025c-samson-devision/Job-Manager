...
const Login = () => {
	...
	return (
		<MainLayout>
			<div style={{ display: "flex", minHeight: "calc(100vh - 200px)", fontFamily: 'Segoe UI, Arial, sans-serif', overflow: "hidden" }}>
				...
				>
					<div style={{
						...
						{error && (
							<div style={{ background: "#fee2e2", color: "#b91c1c", borderRadius: "6px", padding: "0.5rem", textAlign: "center", marginBottom: "1rem", fontSize: "0.95rem", marginTop: "1rem" }}>{error}</div>
						)}
